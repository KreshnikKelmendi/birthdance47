      ...
      {showImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={handleCloseImage}
              className="absolute top-28 right-2 text-red-600 bg-white text-xl  px-2 py-1 rounded-full"
            >
              X
            </button>
          </motion.div>
...
const Banner = () => {
  return (
    <div className='relative bg-[#00000071]'>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 px-5 lg:px-16 gap-14 justify-center">
        {data?.map((item, index) => (
